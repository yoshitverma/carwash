        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddOn_Packages_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leaderboards_Washers_WasherId",
                        column: x => x.WasherId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_Washers_WasherId",
                        column: x => x.WasherId,
                        principalTable: "Washers",
                        principalColumn: "WasherId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@greenwash.com", true, "Admin User", "admin123", "Admin" });

            migrationBuilder.CreateIndex(
                name: "IX_AddOn_PackageId",
                table: "AddOn",
                column: "PackageId");
